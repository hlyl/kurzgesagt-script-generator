...
from src.kurzgesagt.core import ProjectManager, ScriptGenerator, SceneParser
from src.kurzgesagt.models import ProjectConfig, ModelType


def test_complete_workflow(temp_dir, mock_anthropic_client):
    ...
    # 5. Generate scripts
    sg = ScriptGenerator(templates_dir=temp_dir / "templates")
...
def test_export_workflow(temp_dir, sample_project_config, sample_scene):
